...
const ManageComments = () => {
	return <>
		<div className='w-full h-full  bg-gray-50 p-5 '>
			<h2 className='text-2xl text-center font-bold bg-green-400'>Super Comments</h2>
					...
					<table className='w-full'>
						<thead>
							<tr>
								...
								<th className='border-b border-gray-200 p-2'>Comments</th>
						...
						<tr className='text-center'>
								...
								<td className='border-b border-gray-200 p-2'>Comments</td>
