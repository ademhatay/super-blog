...
const ManageUsers = () => {
	return <>
		<div className='w-full h-full  bg-gray-50 p-5 '>
			<h2 className='text-2xl text-center font-bold bg-green-400'>Super Users</h2>
					...
					<table className='w-full'>
						<thead>
							<tr>
								...
								<th className='border-b border-gray-200 p-2'>User</th>
						...
						<tr className='text-center'>
								...
								<td className='border-b border-gray-200 p-2'>User1 Name1</td>
							...
							<tr className='text-center'>
								...
								<td className='border-b border-gray-200 p-2'>User2 Name2</td>
								<td className='border-b flex justify-evenly border-gray-200 p-2'>
									<button className='bg-yellow-400 text-white p-1 rounded-md'>
										Show
									</button>
							...
							<tr className='text-center'>
								...
								<td className='border-b border-gray-200 p-2'>User3 Name3</td>
								<td className='border-b flex justify-evenly border-gray-200 p-2'>
									<button className='bg-yellow-400 text-white p-1 rounded-md'>
										Show
									</button>
